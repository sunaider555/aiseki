...
<div class="jumbotron">
	...
	<p>アップロード完了しました。</p>
	<p><a href="news_list.php" class="btn btn-primary btn-lg" role="button">登録中ニュース一覧</a>　<a href="news_list2.php" class="btn btn-primary btn-lg" role="button">登録中イベント一覧</a></p>
</div></div>
<div class="container">

<?php
//設定ファイル読み込み
require_once 'ota/admin/conf.php';
...
include('ota/admin/parts/basic_hensu3.php');
		}
if($link1 == '1'){
	$man='0';
	}elseif($link1 == '2'){
...
if($link2 == '1'){
	...
	?><span class="top_shoplist_people_box_number-2">%</span></div>
        ...
        <a href="https://contact.app-me.jp/download/134" class="btn_1">アプリ DL</a>
      
      </div><!--element_top-->
      <div class="element_top">
        <a href="takasaki/">
          <div class="top_shoplist_takasaki">
          <img src="img/logo.svg" alt=""><br />
          高崎連雀町店
          </div>
        </a>
...
if($link2 == '1'){
	...
	?><span class="top_shoplist_people_box_number-2">%</span></div>
        ...
        <a href="https://contact.app-me.jp/download/137" class="btn_1">アプリ DL</a>
...
if($link2 == '1'){
	...
	?><span class="top_shoplist_people_box_number-2">%</span></div>
      ...
      <div class="element_top">
        <a href="utsunomiya/">
          <div class="top_shoplist_utsunomiya">
          <img src="img/logo.svg" alt=""><br />
          宇都宮店
          </div>
        </a>
...
if($link2 == '1'){
	...
	?><span class="top_shoplist_people_box_number-2">%</span></div>
        ...
        <a href="https://contact.app-me.jp/download/138" class="btn_1">アプリ DL</a>

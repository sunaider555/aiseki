...
<div class="jumbotron">
	<div class="container"><h1>イベントニュース登録ページ</h1>
	<p>イベントニュース編集ページです。</p>
	<p><a href="news_list.php" class="btn btn-primary btn-lg" role="button">登録中ニュース一覧</a></p>
</div></div>
<div class="container">
  
  <pre class="prettyprint html">ニュース編集・削除</pre>
  
<div class="list-group-item-danger" >ニュースを編集します</div> 
  
    <form action="news_rewrite.php" method="post">
...
<input type="text" name="start" value="<?php echo $start; ?>" autocomplete="off"> 
	  ～ 
	  <input type="text" name="end" value="<?php echo $end; ?>" autocomplete="off">
<input type="hidden" name="blank" value="<?php echo $blank; ?>" />
    ...
    <input name="jpeg" type="hidden" value="<?php echo $jpeg; ?>" /><input name="link" type="hidden" value="1" />
<br />
    <br />
    <div class="text-danger">※ニュースの編集後は必ず「ニュースを送信」ボタンを押してください。</div>
    <br />
    <input name="submit" type="submit" class="btn-info btn-lg" value="ニュースを送信" />
    
    </form>
<p></p>
 
<pre class="prettyprint html">ニュースを削除します</pre>
    <div class="text-danger">※「ニュースを削除」するとデータは復旧できませんのでご注意下さい。</div> 
    <a href="news_edit_2.php?id=<?php echo $id; ?>" class="fancybox fancybox.ajax btn-primary btn" >ニュースを削除する</a> 
 <p></p>
</div></div>

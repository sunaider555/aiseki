...
<html lang="ja"><head>
<meta charset="utf-8">
<title>婚活応援酒場「相席酒場 太田店」</title>
<meta name="description" content="婚活応援酒場「相席酒場 太田店」の店舗情報ページです。婚活応援酒場「相席酒場 太田店」が登場。相席で新しい出会いを見つけよう。女性の方は飲み放題が無料で、更に嬉しい特典も！">
<meta name="keywords" content="太田,群馬,相席,居酒屋,飲み放題,相席酒場">
...
var userFeed = new Instafeed({
  ...
  userId: 8108573750, //ユーザーIDを指定
  accessToken: '8108573750.3cb3dc9.25f1768218584bf186f0bdae2fee6ab1', //アクセストークンを指定
  limit: 6, //取得投稿の上限を設定
...
<div class="page_main">
  <div class="page_base">
	...
	$result=mysqli_query($sql, "SELECT * From `data` WHERE `name2` = 'ota'");
...
if($link2 == '1'){
  ...
  <div class="page_base">
    <div class="page_news_area">
      <div class="wrapper">
		  <?php
$result=mysqli_query($sql, "SELECT * From `news` WHERE blank = '1' AND link = '1'  ORDER by id desc LIMIT 4");
...
?>
  ...
  <ul id="instafeed"></ul>
  <div id="clear"></div>
  <div class="page_base_buttonarea"><a href="https://www.instagram.com/aiseki.ota/" class="btn_3">Instagram</a></div>
  </div><!--page_base-->
  ...
  <div class="page_base">
    ...
    <div class="wrapper my-gallery">
      <figure class="element_floor">
        <a href="../img/ota-floor-1.jpg" data-size="900x600" title="">
        <img src="../img/ota-floor-1.jpg">
        </a>
      </figure>
      <figure class="element_floor">
        <a href="../img/ota-floor-2.jpg" data-size="900x600" title="">
        <img src="../img/ota-floor-2.jpg">
        </a>
      </figure>
      <figure class="element_floor">
        <a href="../img/ota-floor-3.jpg" data-size="900x600" title="">
        <img src="../img/ota-floor-3.jpg">
        </a>
      </figure>
      <figure class="element_floor">
        <a href="../img/ota-floor-4.jpg" data-size="900x600" title="">
        <img src="../img/ota-floor-4.jpg">
        </a>
      </figure>                             
    </div>
    <div class="clear"></div>
  ...
  <div class="page_base">
    <div class="page_shopdata_area">
      ...
      <a href="tel:0276486070" class="tel">0276-48-6070</a><br />
      <br />
    ...
    <ul class="page_shopdata_inline-block">
      <li><a href="https://www.facebook.com/aisekisakaba/" title=""><img src="../img/facebook.svg" alt="" /></a></li>
      <li><a href="https://www.instagram.com/aiseki.ota/" title=""><img src="../img/instagram.svg" alt="" /></a></li>
      <li><a href="https://twitter.com/aiseki_sakaba" title=""><img src="../img/twitter.svg" alt="" /></a></li>

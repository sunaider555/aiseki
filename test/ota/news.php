...
<html lang="ja"><head>
<meta charset="utf-8">
<title>ニュース一覧｜婚活応援酒場「相席酒場 太田店」</title>
<meta name="description" content="婚活応援酒場「相席酒場 太田店」のニュース一覧ページです。婚活応援酒場「相席酒場 太田店」が登場。相席で新しい出会いを見つけよう。女性の方は飲み放題が無料で、更に嬉しい特典も！">
<meta name="keywords" content="太田,群馬,相席,居酒屋,飲み放題,相席酒場,ニュース一覧">
...
<div class="page_main">
  ...
  <div class="page_base">
    <div class="page_news_area">
      <div class="wrapper">
       <?php
$result=mysqli_query($sql, "SELECT * From `news` WHERE blank = '1' AND link = '1' ORDER by id desc");

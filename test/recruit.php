...
<div class="page_main">
  ...
  <div class="page_base">
    <div class="rec_page_baito_1"><span class="rec_page_baito_1-2">時給</span> 900<span class="rec_page_baito_1-2">円～</span></div>
    <div class="rec_page_subtitle">勤務時間</div>
    <div class="rec_page_syousai">
    1日 4時間～・週末勤務出来る方歓迎・見習い期間有り・交通費 正規採用後支給・賄い食有り
    </div>
  ...
  <div class="page_base">
    ...
    <div class="rec_page_syousai">
    上記の期間は例ですが、実績や行動力・売上還元により50万円以上の収入は可能です。<br />
    ※多店舗展開のため、ガッツある、意欲あるスタッフ！大々募集中です！
    </div>
    <div class="rec_page_subtitle">待遇</div>
    <div class="rec_page_syousai">
    短期昇格昇給・交通費支給・制服無料・当社規定有給休暇制度有<br />
    3ヶ月毎に利益還元ボーナス支給
    </div>    

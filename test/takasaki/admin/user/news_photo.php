...
<div class="jumbotron">
	<div class="container"><h1>ホットニュース写真追加・削除ページ</h1>
	<p>ホットニュース写真追加・削除ページです。</p>
...
if ($photo1n == $empty) {
	...
	echo '<img src="../' . $photo1n . '.jpg" alt="photo1" />';
}
?></div>  
  <form action="upload_photo.php" method="post" enctype="multipart/form-data">
  <input class="w_per50" type="file" name="photo1n" />
  <input type="hidden" name="n_id" value="<?php echo $n_id; ?>" /><br />
  <br />
 ...
 <pre class="prettyprint html">ニュース画像を削除します</pre>
  ...
  <a href="news_photo_2.php?n_id=<?php echo $n_id; ?>" class="fancybox fancybox.ajax btn-primary btn" >ニュース画像を削除する</a>    
  <br />

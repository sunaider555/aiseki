...
<html lang="ja"><head>
<meta charset="utf-8">
<title>カレンダー｜婚活応援酒場「相席酒場 宇都宮店」</title>
<meta name="description" content="婚活応援酒場「相席酒場 宇都宮店」のカレンダーページです。婚活応援酒場「相席酒場 宇都宮店」が登場。相席で新しい出会いを見つけよう。女性の方は飲み放題が無料で、更に嬉しい特典も！">
<meta name="keywords" content="宇都宮,栃木,相席,居酒屋,飲み放題,相席酒場,カレンダー">
...
for($i = 1; $i <= $week_of_month * 7; $i++){
	...
	echo "<td class= naiyou>";			
			...
			echo "<td class= naiyou>";
$result=mysqli_query($sql, "SELECT * From `news` WHERE sort>=$news_today AND link='4' ORDER BY sort");
